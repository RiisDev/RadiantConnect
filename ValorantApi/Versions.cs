namespace RadiantConnect.ValorantApi
{
	...
	{
		public static async Task<VersionData?> GetVersionAsync() => await ValorantApiClient.GetAsync<VersionData?>("https://valorant-api.com/v1", "version").ConfigureAwait(false);
